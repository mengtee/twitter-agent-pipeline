  ...
  if (isLoading || !form) {
    return (
      <div className="max-w-3xl">
        <h2 className="text-2xl font-bold text-white mb-6">Persona</h2>
        ...
        <div className="flex gap-2">
          {editing ? (
            <>
              ...
              <button
                onClick={() => { setEditing(false); setForm(persona ?? null); }}
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-lg border border-zinc-800 bg-zinc-900 p-4">
          ...
          {editing ? (
            ...
            <>
              <div className="text-lg font-medium text-white">{form.name}</div>
              <div className="text-sm text-zinc-400 mt-1">{form.bio}</div>
            </>
          )}
        </div>
        ...
        <div className="rounded-lg border border-zinc-800 bg-zinc-900 p-4">
          ...
          {editing ? (
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                <div className="text-zinc-500 text-xs mb-1">Tone</div>
                <div className="text-zinc-300">{form.voice.tone}</div>
              </div>
              <div>
                <div className="text-zinc-500 text-xs mb-1">Style</div>
                <div className="text-zinc-300">{form.voice.style}</div>
              </div>
              <div>
                <div className="text-zinc-500 text-xs mb-1">Vocabulary</div>
                <div className="text-zinc-300">{form.voice.vocabulary.join(", ") || "—"}</div>
              </div>
              <div>
                <div className="text-zinc-500 text-xs mb-1">Avoid</div>
                <div className="text-zinc-300">{form.voice.avoid.join(", ") || "—"}</div>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="rounded-lg border border-zinc-800 bg-zinc-900 p-4">
          ...
          {editing ? (
            ...
            <div className="grid grid-cols-3 gap-4 text-sm">
              <div>
                <div className="text-zinc-500 text-xs mb-1">Interests</div>
                <div className="text-zinc-300">{form.topics.interests.join(", ")}</div>
              </div>
              <div>
                <div className="text-zinc-500 text-xs mb-1">Expertise</div>
                <div className="text-zinc-300">{form.topics.expertise.join(", ")}</div>
              </div>
              <div>
                <div className="text-zinc-500 text-xs mb-1">Avoid</div>
                <div className="text-zinc-300">{form.topics.avoid.join(", ")}</div>
              </div>
            </div>
          )}
        </div>
